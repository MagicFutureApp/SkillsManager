...
export default function Footer({ onScrollToTop }: FooterProps) {
  ...
  return (
    <footer className="bg-[#0b0f19] text-slate-400 border-t border-white/10" id="footer">
            ...
            <div className="max-w-md w-full space-y-4">
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2">
                <input
                  ...
                  className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-xs font-semibold text-white placeholder-slate-500 focus:border-blue-500 focus:outline-none"
                />
                <button
                  type="submit"
                  className="flex items-center justify-center gap-1.5 shrink-0 rounded-lg bg-blue-600 px-4 py-2.5 text-xs font-bold text-white shadow-lg shadow-blue-600/20 transition-all hover:bg-blue-500 cursor-pointer active:scale-95"
        ...
        <div className="grid grid-cols-2 gap-8 py-12 md:grid-cols-4 lg:py-16">
          ...
          <div className="flex flex-col justify-between items-start md:items-end col-span-2 md:col-span-1">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-lg border border-white/10 bg-white/5 px-3.5 py-2 text-xs font-semibold text-slate-300 transition-colors hover:bg-white/10 hover:text-white cursor-pointer"
              id="footer-back-to-top"
            >
              <span>Back to Top</span>
              <ArrowUp className="h-3.5 w-3.5" />
            </button>
            <span className="text-[10px] text-slate-600 mt-4 font-mono select-none">
              v1.0.0 Stable Build
            </span>
          </div>
        </div>
