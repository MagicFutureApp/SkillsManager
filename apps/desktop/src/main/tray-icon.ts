...
export const getAppIconPath = (mainDirname: string): string => path.join(mainDirname, "..", "..", "renderer", APP_ICON_FILE);

export const getTrayIconPath = getAppIconPath;

export const getMacOsTrayIconPath = (mainDirname: string): string => path.join(mainDirname, "..", "..", "renderer", MACOS_TRAY_ICON_FILE);

export const createTrayIconImage = (mainDirname: string, platform: NodeJS.Platform = process.platform): string | NativeImage => {
