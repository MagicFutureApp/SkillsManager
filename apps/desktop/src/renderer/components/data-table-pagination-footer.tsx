              ...
              >
                <PaginationContent>
                  <PaginationItem>
                    <PaginationPrevious
                      href="#"
                      text={t(`${labelKeyPrefix}.previous`)}
                    ...
                    <PaginationItem key={paginationPage}>
                      {typeof paginationPage === "number" ? (
                        <PaginationLink
                          ...
                          aria-label={t(`${labelKeyPrefix}.pageAriaLabel`, {
                            page: paginationPage
                          })}
                          onClick={(event) => {
                            event.preventDefault();
                  ...
                  <PaginationItem>
                    <PaginationNext
                      href="#"
                      text={t(`${labelKeyPrefix}.next`)}
                      aria-label={t(`${labelKeyPrefix}.next`)}
