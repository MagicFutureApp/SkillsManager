...
describe("createI18nInstance", () => {
  ...
  it("keeps Chinese sort option labels to two characters", async () => {
    ...
    const sortLabels = [i18n.t("skills.filters.sortRecommended"), i18n.t("skills.filters.sortName"), i18n.t("skills.filters.sortRepository"), i18n.t("providers.filters.sortPriority"), i18n.t("providers.filters.sortName"), i18n.t("providers.filters.sortStatus"), i18n.t("providers.filters.sortProvider"), i18n.t("repositories.filters.sortPriority"), i18n.t("repositories.filters.sortName"), i18n.t("repositories.filters.sortProvider"), i18n.t("repositories.filters.sortStatus"), i18n.t("repositories.filters.sortSkills")];

    expect(sortLabels).toEqual(["推荐", "名称", "仓库", "优先", "名称", "状态", "类型", "优先", "名称", "类型", "状态", "技能"]);
