...
export { MAIN_MINI_WIDTH, SIDEBAR_AUTO_COLLAPSE_WIDTH, SIDEBAR_COLLAPSE_WIDTH, SIDEBAR_EXPAND_WIDTH } from "../../core/app-constants";
...
export const useShellStore = create<ShellStore>((set) => ({
  ...
  setSidebarAutoCollapsedByWidth: (width) => set({ isSidebarAutoCollapsed: width <= SIDEBAR_AUTO_COLLAPSE_WIDTH })
}));
